...
// TODO Insert Figure 6.5 and figure out where to reference it.
...
// TODO Insert Figure 6.6 and figure out where to reference it.
...
// TODO Insert Figure 6.7 and figure out where to reference it
...
As you can see from Figure 6.8, when we put all the components together, it becomes quite a complex and inter-dependent system.
...
This framework consists of 4 layers, building on top of each other as shown in Figure 6.9.
These layers are:
...
* 6.1 — 1. Secure Ingestion, 2. Endpoint Protection, 3. Software Authorization, 4. Secure Software Factory, 5. Secure Development
* 6.2 — 1, False, False
