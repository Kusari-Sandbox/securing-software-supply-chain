...
* Exercise 5.1 — B — It's when unprivileged code is promoted to privileged environments
* Exercise 5.2 — D — Social engineering attacks on the project stakeholders
* Exercise 5.3 — B — Automated generation of secure code
